// Exercício 18
// Josefina deseja saber se o saldo de sua conta no banco e suficiente para pagar a dívida do armazém. 
// Faça um programa para ler o saldo de sua conta no banco, o valor de sua dívida e imprima a mensagem mais adequada conforme o caso: 
// - a dívida não pode ser paga - saldo suficiente para pagar até o dia 10 
...
// Exemplo de cálculo: Se Josefina possui R$310,00 de saldo e sua dívida for de R$300,00 deverá ser impressa a mensagem: 
// “Saldo suficiente para pagar até o dia 20”, pois o saldo só e suficiente para pagar um acréscimo de até 3% (R$ 309,00), já que se for atribuído um acréscimo de 5% a dívida passara a R$315,00. 
